var my_system_chart = echarts.init(document.getElementById('system-chart'));
var schema = [{
    name: 'date',
    index: 0,
    text: '日'
...
option = {
    ...
    series: [{
        ...
        //定义设备节点
        data: [{
            symbol: 'image://../../resources/images/tower.jpg',
            symbolSize: [92, 100],
            name: '1#冷却塔',
            value: [0, 20],
        }, {
            symbol: 'image://../../resources/images/coolpunp1.jpg',
            symbolSize: [62, 34],
            name: '1#冷却泵',
            value: [0, 10],
        }, {
            symbol: 'image://../../resources/images/coolpump2.jpg',
            symbolSize: [62, 34],
            name: '2#冷却泵',
            value: [0, 0],
        }, {
            symbol: 'image://../../resources/images/freeze.jpg',
            symbolSize: [62, 34],
            name: '1#冷冻泵',
            value: [50, 10],
        }, {
            symbol: 'images://../../resources/images/freeze2.jpg',
            symbolSize: [62, 34],
            name: '2#冷冻泵',
            value: [50, 0],
        }, {
            symbol: 'image://../../resources/images/chiller01.jpg',
            symbolSize: [119, 89],
            name: '1#主机',
            value: [25, 10],
        }, {
            symbol: 'image://../../resources/images/chiller2.jpg',
            symbolSize: [119, 89],
            name: '2#主机',
            value: [25, 1],
        }, {
            symbol: 'image://../../resources/images/trap.jpg',
            symbolSize: [101, 53],
            name: '冷冻分水器',
            value: [75, 10],
        }, {
            symbol: 'image://../../resources/images/collector.jpg',
            symbolSize: [101, 53],
            name: '冷却集水器',
            value: [75, 0],
        }, ],
